...
class MigrationPlan:
    ...
    def save_report(self, file_path: str) -> None:
        ...
        with open(file_path, "w", encoding="utf-8") as f:
            f.write(f"# Prompt Migration Plan\n\n")
            ...
            f.write(f"## New Template Definitions\n\n")
            ...
            f.write(f"## Migration Steps By File\n\n")
            ...
            f.write(f"## Migration Steps By Priority\n\n")
...
class MigrationPlanner:
    ...
    def create_template_definition(
        self, prompt_content: str, provider: str, complexity: str
    ) -> str:
    ...
    def generate_migration_code(
        self, prompt_content: str, provider: str, has_variables: bool
    ) -> str:
        """Generate migration code for a prompt."""
        if provider == "unknown":
            provider = "openai"  # Default to OpenAI for unknown providers
        
        template_id = self.create_template_definition(
            prompt_content, provider, "medium" if has_variables else "low"
        )
