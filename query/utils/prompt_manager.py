...
class PromptManager:
    ...
    def __init__(
        ...
        schema_rules: dict[str, list[str]] | None = None,
        llm_client = None,
    ) -> None:
        """
    ...
    def create_prompt(
        ...
        template_name: str,
        optimize: bool = True,
        strategies: list[PromptOptimizationStrategy] | None = None,
        **kwargs,
    ) -> dict[str, str]:
        """
    ...
    def _llm_review_contradictions(self, system_prompt: str, user_prompt: str) -> tuple[str, str]:
        ...
        try:
            ...
            logger.exception(f"Error in LLM review: {e!s}")
            return system_prompt, user_prompt
...
def main() -> None:
    ...
    len(prompt_manager.tokenizer.encode(
