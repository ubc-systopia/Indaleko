...
class RecommendationEngine:
    ...
    def _initialize_providers(self) -> None:
        ...
        self.providers[RecommendationSource.ACTIVITY_CONTEXT] = ActivityContextRecommender(
            db_config=None,  # Use default config
            debug=self.debug
        )
    ...
    def _rank_suggestions(
        ...
        for suggestion in sorted_suggestions:
            ...
            max_per_source = int(max(1, 2 * self.settings.source_weights.get(source, 1.0)))
    ...
    def get_acceptance_rate(self, source_type: Optional[RecommendationSource] = None) -> float:
        """
