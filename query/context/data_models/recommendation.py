...
class QuerySuggestion(IndalekoBaseModel):
    ...
    rationale: str = Field(..., description="Explanation of why this query is suggested")
    confidence: float = Field(..., description="Confidence score (0.0-1.0)")
    source: RecommendationSource = Field(..., description="Source of this recommendation")
...
class RecommendationFeedback(IndalekoBaseModel):
    ...
    suggestion_id: uuid.UUID = Field(..., description="ID of the suggestion receiving feedback")
    feedback_type: FeedbackType = Field(..., description="Type of feedback provided")
    result_count: Optional[int] = Field(None, description="Number of results from the suggested query")
    user_comments: Optional[str] = Field(None, description="Optional user comments")
...
class RecommendationSettings(IndalekoBaseModel):
    ...
    store_history: bool = Field(True, description="Whether to store recommendation history")
