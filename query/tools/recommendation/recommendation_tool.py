...
from query.context.data_models.recommendation import FeedbackType
    ...
    def _get_recommendations(
        ...
        try:
            ...
            return ToolOutput(
                success=False,
                result=None,
                error=f"Error generating recommendations: {e!s}",
                tool_name=self.definition.name,
            )
    ...
    def _provide_feedback(
        ...
        try:
            ...
            return ToolOutput(
                success=False,
                result=None,
                error=f"Error recording feedback: {e!s}",
                tool_name=self.definition.name,
            )
    ...
    def _get_stats(self) -> ToolOutput:
        ...
        try:
            ...
            return ToolOutput(
                success=False,
                result=None,
                error=f"Error retrieving statistics: {e!s}",
                tool_name=self.definition.name,
            )
