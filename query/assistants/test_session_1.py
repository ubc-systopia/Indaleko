...
def run_session_1():
    ...
    manager.add_user_message(conversation_id, "I'm working on my thesis about UPI (Unified Personal Index).")
    
    print("Assistant: That's interesting! Can you tell me more about your thesis on UPI?")
    manager.add_assistant_message(conversation_id, "That's interesting! Can you tell me more about your thesis on UPI?")
    
    print("User: It's focusing on how to unify data across disparate sources for personal knowledge management.")
    manager.add_user_message(conversation_id, "It's focusing on how to unify data across disparate sources for personal knowledge management.")
    
    print("Assistant: That sounds like an important area of research. Are you implementing a prototype?")
    manager.add_assistant_message(conversation_id, "That sounds like an important area of research. Are you implementing a prototype?")
    
    print("User: Yes, I'm using Archivist as the demonstration vehicle for my UPI concept.")
    manager.add_user_message(conversation_id, "Yes, I'm using Archivist as the demonstration vehicle for my UPI concept.")
    
    # Extract information and update context
    conversation.set_context_variable("thesis_topic", "UPI")
    conversation.set_context_variable("thesis_focus", "unifying data across disparate sources")
    ...
    # Add key takeaways
    conversation.add_key_takeaway("User is working on thesis about Unified Personal Index (UPI)")
    conversation.add_key_takeaway("Thesis focuses on unifying data across disparate sources")
    conversation.add_key_takeaway("Archivist is being used as demonstration vehicle for UPI")
    ...
    print(f"Continuation ID saved to continuation_id.txt")
