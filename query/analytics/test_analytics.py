...
def main():
    ...
    parser.add_argument("--types", "-t", action="store_true", help="Test file type distribution")
    parser.add_argument("--sizes", "-s", action="store_true", help="Test file size statistics")
    parser.add_argument("--ages", action="store_true", help="Test file age distribution")
    parser.add_argument("--report", "-r", action="store_true", help="Test comprehensive report generation")
