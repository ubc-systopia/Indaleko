...
class ActiveRefinement(IndalekoBaseModel):
    ...
    applied_at: datetime = Field(default_factory=datetime.now, description="When this refinement was applied")
...
class QueryRefiner:
    ...
    def remove_refinement(self, facet_name: str, value: str) -> Tuple[str, QueryRefinementState]:
        """
        ...
        self.current_state.active_refinements = [
            r for r in self.current_state.active_refinements 
    ...
    def _apply_content_type_refinement(self, refinements: List[ActiveRefinement]) -> str:
    ...
    def get_facet_options(self, facets: DynamicFacets) -> Dict[str, List[Dict[str, Any]]]:
        """
    ...
    def get_active_refinement_by_index(self, index: int) -> Optional[ActiveRefinement]:
        """
