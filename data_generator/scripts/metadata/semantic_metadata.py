...
class SemanticMetadata(Metadata):
    ...
    TEXT_TAGS = ["Title", "Subtitle", "Header", "Footer", "Paragraph", "BulletPoint", "NumberedList", 
                "Caption", "Quote", "Metadata", "UncategorizedText", "SectionHeader", "Footnote", 
                "Abstract", "FigureDescription", "Annotation"]
    LANGUAGES = "English"
    ...
    def generate_metadata(self, record_data: IndalekoRecordDataModel, IO_UUID: str, semantic_attributes_data: list[Dict[str, Any]]) -> BaseSemanticDataModel:
