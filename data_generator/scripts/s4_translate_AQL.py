...
class AQLQueryConverter(TranslatorBase):
    ...
    geo_coordinates: str, n_truth: int, llm_connector: Any) -> str:
        ...
        dynamic_prompt = self._create_translation_prompt_dynamically(selected_md_attributes, collections, geo_coordinates, n_truth)
    ...
    def _create_translation_prompt_dynamically(self, selected_md_attributes:Dict[str, Any], collections: dict[str], 
    geo_coordinates: str, n_truth: int) -> str:
        """
        Create a prompt for the LLM to generate an AQL query.
