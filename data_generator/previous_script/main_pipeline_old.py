...
class Validator():
    ...
    def run(self) -> None:
        ...
        #selected_md_attributes = {"Posix":{"file.name":{"extension":[".txt"]},"timestamps":{"birthtime":{"starttime":"2025-01-27T20:00:00","endtime":"2025-01-27T20:00:00","command":"equal"},"modified":{"starttime":"2025-01-28T14:54:17","endtime":"2025-01-28T14:54:17","command":"equal"},"changed":{"starttime":"2025-01-28T14:55:17","endtime":"2025-01-28T14:55:17","command":"equal"}}},"Activity":{"geo_location":{"location":"Vancouver, BC","command":"at","timestamp":"birthtime"}}}
        #selected_md_attributes = {"Posix": {"file.name": {"pattern": "city", "command": "contains", "extension": [".pdf"]}, "timestamps": {"birthtime": {"starttime": "2025-01-26T00:00:00", "endtime": "2025-01-26T23:59:59", "command": "range"}}}, "Semantic": {"Content_1": {"PageNumber": 8, "Text": "city", "Type": "Title"}, "Content_2": {"Text": "vancouver", "Type": "Subtitle"}}, "Activity": {"geo_location": {"location": "Vancouver, BC", "command": "at", "timestamp": "birthtime"}, "ecobee_temp": {"temperature": {"start": 30.0, "end": 30.0, "command": "equal"}, "timestamp": "birthtime"}, "ambient_music": {"album_name": "pop", "source": "spotify", "timestamp": "birthtime"}}}
        #selected_md_attributes = {'Posix': {'file.name': {'extension': ['.txt']}, 'timestamps': {'birthtime': {'starttime': "2025-01-16T00:00:00", 'endtime': "2025-01-16T23:59:59", 'command': 'range'}}}, 'Semantic': {}, 'Activity': {'geo_location': {'location': 'Langley', 'command': 'at', 'timestamp': 'birthtime'}, 'ambient_music': {'track_name': 'Happy', 'playback_position_ms': 150000, 'timestamp': 'birthtime'}}}
        #selected_md_attributes = {'Posix': {'file.name': {'pattern': 'present', 'command': 'exactly', 'extension': ['.ppt', '.pptx']}, 'timestamps': {'birthtime': {'starttime': "2025-01-16T00:00:00", 'endtime': "2025-01-16T23:59:59", 'command': 'range'}}}, 'Semantic': {'Content_1': {'Text': 'present', 'Type': 'Title'}}, 'Activity': {'geo_location': {'location': 'Vancouver', 'command': 'at', 'timestamp': 'birthtime'}}}
        #selected_md_attributes = {'Posix': {'file.name': {'extension': ['.ppt', '.pptx'], 'command': 'contains'}, 'timestamps': {'birthtime': {'starttime': "2025-01-16T00:00:00", 'endtime': "2025-01-16T23:59:59", 'command': 'range'}}}, 'Semantic': {}, 'Activity': {'ambient_music': {'artist_name': 'John', 'timestamp': 'birthtime'}}}
        # failing...
        #selected_md_attributes = {'Posix': {'file.name': {'pattern': 'present', 'command': 'exactly', 'extension': ['.ppt', '.pptx']}, 'timestamps': {'birthtime': {'starttime':  "2025-01-16T00:00:00", 'endtime':  "2025-01-16T23:59:59", 'command': 'range'}}}, 'Semantic': {}, 'Activity': {'geo_location': {'location': 'Vancouver', 'command': 'at', 'timestamp': 'birthtime'}, 'ambient_music': {'artist_name': 'John', 'timestamp': 'birthtime'}}}
        ...
        all_records_md, all_geo_activity_md, all_temp_activity_md, all_music_activity_md, all_machine_config_md, stats = results[0], results[1], results[2], results[3], results[4], results[5]
