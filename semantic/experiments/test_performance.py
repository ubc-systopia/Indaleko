...
class TestPerformanceMonitor(unittest.TestCase):
    ...
    def test_mime_detector_integration(self):
        ...
        # Stop monitoring
        metrics = self.monitor.stop_monitoring(context, success=True, additional_data=mime_data)
    ...
    def test_multiple_files(self):
        ...
        for file_path in self.test_files:
            ...
            self.monitor.stop_monitoring(context, success=True, additional_data=mime_data)
