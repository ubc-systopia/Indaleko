...
class UnstructuredRetrieval:
    ...
    def create_bind_mounts(self):
        ...
        bind_mounts[self.unstructured_config['VOLUMES']['HostDrive']] = {'bind':self.unstructured_config['VOLUMES']['HostDriveMount'], 'mode':'rw'}

        # Create bind mount for project directory
        bind_mounts[self.unstructured_config['VOLUMES']['ProjectDir']] = {'bind': self.unstructured_config['VOLUMES']['ProjectDirMount'], 'mode': 'rw'}

        # Create bind mount for Data I/O
        bind_mounts[self.unstructured_config['DATA']['UnstructuredDataDir']] = {'bind': self.unstructured_config['VOLUMES']['UnstructuredDataDirMount'], 'mode': 'rw'}
    ...
    def retrieve(self, container_name):
        ...
        ic((f"Running the Docker container '{container_name}' with necessary volume mounts..."))
        ...
        unix_script_path = self.windows_to_unix_path(self.unstructured_config['DATA']['ScriptsDir'])
