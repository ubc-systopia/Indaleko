    ...
    def test_filter_files(self, mock_run):
        ...
        input_models = [
            UnstructuredInputDataModel(
                ...
                ModificationTimestamp=datetime.fromtimestamp(os.path.getmtime(self.text_file), timezone.utc),
            ...
            UnstructuredInputDataModel(
                ...
                ModificationTimestamp=datetime.fromtimestamp(os.path.getmtime(self.pdf_file), timezone.utc),
            ...
            UnstructuredInputDataModel(
                ...
                ModificationTimestamp=datetime.now(timezone.utc),
                Length=1024,
                Checksum=None
            ),
...
class TestUnstructuredRecorder(unittest.TestCase):
    ...
    def test_create_attribute(self):
        ...
        # Verify the results
        self.assertEqual(title_attr.Identifier.Identifier, self.recorder.attribute_map["Title"])
        self.assertEqual(title_attr.Value, "Test Title")
        
        self.assertEqual(filename_attr.Identifier.Identifier, self.recorder.attribute_map["filename"])
        self.assertEqual(filename_attr.Value, "test.pdf")
        
        # Unknown attribute should use the SEM_UNUSED UUID
        self.assertEqual(unknown_attr.Identifier.Identifier, self.recorder.attribute_map.get("unknown", "5cc55605-64f2-4491-9ff1-ddfe23e964b8"))
...
class TestUnstructuredProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_collector_collect = patch.object(self.processor._collector, "collect_data").start()
        
        # Mock the recorder's store_data method
        self.mock_recorder_store = patch.object(self.processor._recorder, "store_data").start()
                ...
                "Unstructured": [
                    {
                        "type": "Title",
                        "text": "Test Title",
                        "metadata": {"filetype": "application/pdf", "languages": ["eng"]}
                    }
                ]
            }
        ]
