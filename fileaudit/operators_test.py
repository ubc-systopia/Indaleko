...
class TestInputReader(unittest.TestCase):
    ...
    def test_exception_handling(self):
        ...
        with patch("subprocess.Popen") as mock_popen:
            mock_process = mock_popen.return_value
            mock_process.stdout = StringIO("")
            mock_process.communicate.side_effect = Exception("Something went wrong")
...
class TestCanonize(unittest.TestCase):
    def generate_mock_input(self, syscall: str):
        all_samples = [
            ...
            (
                ...
                [
                    ...
                    "F=35",
                    "(R_______F_V_)",
                    "Library/Mail/V8/E7E363C2-BB21-4A69-A1E5-CB22FB478997/[Gmail].mbox/All",
                    "Mail.mbox/D22A1D5B-AA8F-41A3-892E-930CF85504E8/Data/8/9/3/Messages/398336.partial.emlx",
                    "0.000218",
                    "ampdaemon.250630",
                ],
            ),
            (
                ...
                [
                    ...
                    "F=33",
                    "(R_______F_V_)",
                    "/Users/sinaee/Library/Application",
                    "Support/Google/Chrome/Profile",
                    "1/Shortcuts",
                    "0.000185",
                    "ampdaemon.250630",
                ],
            ...
            (
                ...
                [
                    ...
                    "for",
                    "Endpoints",
                    "Connector/scannertmp/20240329_195217-scantemp.524e726695",
                    "0.000198",
                    "ampscansvc.8242",
                ],
            ),
            (
                ...
                [
                    ...
                    "mkdir",
                    "[17]",
                    "private/var/folders/qk/4xtqd_nn3kx8q5m4df7prpzh0000gp/T",
                    "0.000004",
                    "git.464994",
                ],
            ),
            ...
            (
                ...
                [
                    ...
                    "/Users/sinaee/Library/Application",
                    "Support/Google/Chrome/Profile",
                    "1/IndexedDB/https_docs.google.com_0.indexeddb.leveldb/LOG",
                    "0.000855",
                    "Google",
                    "Chrome.8803",
                ],
            ...
            (
                ...
                [
                    "19:52:34.782196",
                    "rename",
                    "/Users/sinaee/Library/Caches/Google/Chrome/Profile",
                    "1/Cache/Cache_Data/dcceb247e0b3a75d_0",
                    "0.000402",
                    "Google",
                    "Chrome",
                    "Helper.8882",
        ...
        return [
            syscall_sample
            for syscall_sample in all_samples
            ...
            "expect": [
                (
                    ...
                    [
                        ...
                        "rename",
                        "-1",
                        "/Users/sinaee/Library/Application Support/Google/Chrome/Profile 1/IndexedDB/https_docs.google.com_0.indexeddb.leveldb/LOG",
                        "Google Chrome",
                        "8803",
                    ],
                ),
                (
                    ...
                    [
                        ...
                        "rename",
                        "-1",
                        "/Users/sinaee/Library/Caches/Google/Chrome/Profile 1/Cache/Cache_Data/dcceb247e0b3a75d_0",
                ...
                (
                    ...
                    [
                        ...
                        "rename",
                        "-1",
                        "/Users/sinaee/Library/Application Support/Google/Chrome/Profile 1/.com.google.Chrome.HL1NBs",
                        "Google Chrome",
                        "8803",
                    ],
                ),
            ...
            "expect": [
                (
                    ...
                    [
                        ...
                        "mkdir",
                        "-1",
                        "/Library/Application Support/Cisco/AMP for Endpoints Connector/scannertmp/20240329_195217-scantemp.524e726695",
                        "ampscansvc",
                        "8242",
                    ],
                ),
            ...
            "expect": [
                (
                    ...
                    [
                        ...
                        "open",
                        "35",
                        "Library/Mail/V8/E7E363C2-BB21-4A69-A1E5-CB22FB478997/[Gmail].mbox/All Mail.mbox/D22A1D5B-AA8F-41A3-892E-930CF85504E8/Data/8/9/3/Messages/398336.partial.emlx",
                        "ampdaemon",
                        "250630",
                    ],
                ),
                (
                    ...
                    [
                        ...
                        "open",
                        "33",
                        "/Users/sinaee/Library/Application Support/Google/Chrome/Profile 1/Shortcuts",
                        "ampdaemon",
                        "250630",
                    ],
                ),
                ...
                (
                    ...
                    [
                        ...
                        "open",
                        "-1",
                        "/Users/sinaee/Library/Application Support/Google/Chrome/Profile",
                        "Google Chrome",
                        "7874",
                    ],
                ),
