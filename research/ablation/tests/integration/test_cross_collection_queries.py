...
*                                                                          *
* Please use test_cross_collection_queries_proper.py instead,              *
...
print("WARNING: test_cross_collection_queries.py uses mocks and violates the fail-stop principle.")
print("Please use test_cross_collection_queries_proper.py instead.")
...
class TestCrossCollectionQueriesIntegration(unittest.TestCase):
    ...
    def test_generate_cross_collection_queries_with_registry(self):
        ...
        with patch.object(
            ...
            mock_generate.assert_called_once_with(ActivityType.TASK, ActivityType.COLLABORATION, "discussed_in")
