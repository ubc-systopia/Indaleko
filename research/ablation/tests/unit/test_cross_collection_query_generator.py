...
class TestCrossCollectionQueryGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('research.ablation.query.enhanced.cross_collection_query_generator.EnhancedQueryGenerator') as mock_enhanced:
    ...
    def test_generate_diverse_cross_collection_queries(self):
        ...
        self.generator.generate_cross_collection_queries = MagicMock(side_effect=[
            [mock_query1], [mock_query2], [mock_query3]
        ])
