...
from ..models.ablation_results import AblationQueryTruth, AblationTestMetadata
...
class TestAblationTestRunner(unittest.TestCase):
    ...
    def setUp(self, mock_db_config, mock_db_manager, mock_truth_tracker, mock_query_generator):
        ...
        self.test_runner._execute_query = MagicMock(
            return_value=[
    ...
    def test_test_query(self, mock_time):
        ...
        self.assertEqual(len(self.test_runner.test_collections), self.mock_db_manager.ablate_collection.call_count)
        self.assertEqual(len(self.test_runner.test_collections), self.mock_db_manager.restore_collection.call_count)
        ...
        self.assertEqual(len(self.test_runner.test_collections), self.test_runner._save_result.call_count)
