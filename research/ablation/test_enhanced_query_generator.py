...
def test_generator(activity_type: str, count: int, verbose: bool = False) -> list[str]:
    ...
    try:
        ...
        try:
            ...
            try:
                direct_queries = generator.generator.generate_queries_for_activity_type(activity_type, count=count)
...
def main():
    ...
    parser.add_argument("--activity-type", type=str, default="location", help="Activity type to generate queries for")
