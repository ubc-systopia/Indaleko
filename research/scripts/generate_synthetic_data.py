...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="The number of activities to generate (default: 100)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="The number of test queries to generate (default: 10)"
    )
    ...
    parser.add_argument(
        "--record",
        action="store_true",
        help="Record the generated data to the database"
    )
