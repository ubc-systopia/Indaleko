...
class IndalekoLinuxMachineConfig:
    ...
    def get_most_recent_config_file(config_dir : str):
        ...
        candidate_files = [(timestamp, filename) for filename, guid, timestamp in [IndalekoLinuxMachineConfig.get_guid_timestamp_from_file_name(x) for x in candidates]]
...
def build_stat_dict(name: str, root : str, config : IndalekoLinuxMachineConfig, last_uri = None, last_drive = None) -> tuple:
