...
class TestGoogleDriveCollector(unittest.TestCase):
    ...
    def test_get_collector_name(self):
        ...
        assert self.collector.get_collector_name() == "Google Drive Activity Collector"

    def test_get_provider_id(self):
        """Test get_provider_id method."""
        assert self.collector.get_provider_id() == uuid.UUID("3e7d8f29-7c73-41c5-b3d4-1a9b42567890")
    ...
    def test_get_collector_characteristics(self):
        ...
        for char in characteristics:
            assert isinstance(char, ActivityDataCharacteristics)
    ...
    def test_activity_conversion(self):
        ...
        if self.collector.activities:
            ...
            assert storage_activity.file_id == activity.file.file_id
            assert storage_activity.file_name == activity.file.name
            assert storage_activity.mime_type == activity.file.mime_type
...
class TestGoogleDriveRecorder(unittest.TestCase):
    ...
    def test_recorder_initialization(self):
        ...
        assert self.recorder._name == "Google Drive Storage Activity Recorder"
        assert self.recorder._provider_type == "google_drive"
        assert self.recorder._gdrive_collector == self.collector
    ...
    def test_build_gdrive_activity_document(self, mock_get_attributes):
        ...
        assert document["Record"]["Data"]["file_id"] == "test-file-1"
        assert document["Record"]["Data"]["file_name"] == "Test Document.docx"
    ...
    def test_store_activity(self, mock_build_doc):
        ...
        # Verify result
        assert result == storage_activity.activity_id
