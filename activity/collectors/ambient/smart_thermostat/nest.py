...
from activity.collectors.ambient.smart_thermostat.smart_thermostat import SmartThermostatCollector
from activity.collectors.ambient.smart_thermostat.nest_data_model import NestAmbientDataModel
            ...
            for device in devices:
                if device['type'] == 'sdm.devices.types.THERMOSTAT':
                    raw_data = {
                        ...
                        "connected_sensors": len(device['traits'][
