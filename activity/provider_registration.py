...
class IndalekoActivityDataProviderRegistration:
    ...
    def generate_activity_data_provider_collection_name(identifier : str) -> str:
        ...
        prefix = IndalekoActivityDataProviderRegistration.provider_prefix
...
def main():
    ...
    example = IndalekoActivityDataProviderRegistrationDataModel.Config.json_schema_extra['example']
    ic(example)
