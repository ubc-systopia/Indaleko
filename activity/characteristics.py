'''
This module defines the ProviderCharacteristics class.  This class is used to
...
class ActivityDataCharacteristics:
    ...
    '''
    PROVIDER_TEMPORAL_DATA = '521e13be-096e-4068-8f2a-4c162bd6a3fb'
    PROVIDER_SPATIAL_DATA = 'a77d0a02-a716-4d5e-a7e2-cabab87e00e6'
    PROVIDER_COMMUNICATION_DATA = 'c9f9f8d1-345f-4af6-ac65-23bdfec32e62'
    PROVIDER_SEARCH_DATA = 'c9f9f8d1-345f-4af6-ac65-23bdfec32e62'
    PROVIDER_STORAGE_ACTIVITY_DATA = 'ddfd3625-3c37-4b4c-b416-e0c4bd7ec010'
    ...
    def get_provider_characteristics():
        ...
        return {
            label : value for label, value in ActivityDataCharacteristics.__dict__.items() if label.startswith('PROVIDER_')
        }

    @staticmethod
    def get_provider_label(uuid: uuid.UUID):
        '''Get the label for the provider'''
        return ActivityDataCharacteristics().uuid_to_label.get(uuid, None)
...
def main():
    ...
    for label, value in ActivityDataCharacteristics.get_provider_characteristics().items():
        ic(label, value)
        ic(ActivityDataCharacteristics.get_provider_label(value))
