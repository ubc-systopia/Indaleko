...
class DiscordFileShareRecorder(RecorderBase):
    ...
    def __init__(self, collector: Optional[DiscordFileShareCollector] = None, **kwargs):
    ...
    def get_collector_class_model(self) -> Dict[str, type]:
        ...
        return {
            "DiscordDataModel": DiscordDataModel,
    ...
    def create_semantic_attributes(self, attachment: Dict) -> List[IndalekoSemanticAttributeDataModel]:
        """
    ...
    def store_attachment(self, attachment: Dict) -> Dict:
        ...
        self.logger.info(f"Stored attachment: {attachment.get('filename')} (key: {result})")
    ...
    def lookup_attachment_by_url(self, url: str) -> Optional[Dict]:
        """
