...
class MemoryConsolidationManager:
    ...
    def consolidate_sensory_to_short_term(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Log results
            self._logger.info(
                f"Consolidated {stats.get('entities_consolidated', 0)} entities to short-term memory",
            )
    ...
    def consolidate_short_term_to_long_term(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Log results
            self._logger.info(
                f"Consolidated {stats.get('entities_consolidated', 0)} entities to long-term memory",
            )
            self._logger.info(f"Execution time: {stats['execution_time']:.2f} seconds")
    ...
    def consolidate_long_term_to_archival(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Log results
            self._logger.info(
                f"Consolidated {stats.get('entities_consolidated', 0)} entities to archival memory",
            )
            self._logger.info(f"Execution time: {stats['execution_time']:.2f} seconds")
    ...
    def consolidate_all(self) -> dict[str, Any]:
        ...
        # Log results
        self._logger.info("Completed full memory consolidation process")
...
def main():
    ...
    try:
        if args.consolidate_sensory:
            if args.dry_run:
                logger.info(
                    "DRY RUN: Simulating sensory to short-term memory consolidation",
                )
                results = {
                    "status": "dry_run",
                    "consolidation_type": "sensory_to_short_term",
                }
            else:
            ...
            if args.dry_run:
                logger.info(
                    "DRY RUN: Simulating short-term to long-term memory consolidation",
                )
                results = {
                    "status": "dry_run",
            ...
            if args.dry_run:
                logger.info(
                    "DRY RUN: Simulating long-term to archival memory consolidation",
                )
                results = {
                    "status": "dry_run",
                    "consolidation_type": "long_term_to_archival",
