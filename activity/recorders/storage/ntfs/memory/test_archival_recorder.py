...
def test_ontology_enhancement():
    ...
    for relationship in ontology["relationships"]:
        print(f"  {relationship['source']} {relationship['relation']} {relationship['target']}")
...
def main():
    ...
    test_group.add_argument("--test-ontology", action="store_true",
                          help="Test ontology enhancement")
    test_group.add_argument("--test-consolidation", action="store_true",
                          help="Test consolidation from long-term memory")
    test_group.add_argument("--test-knowledge-graph", action="store_true",
                          help="Test knowledge graph construction")
    test_group.add_argument("--test-search", action="store_true",
