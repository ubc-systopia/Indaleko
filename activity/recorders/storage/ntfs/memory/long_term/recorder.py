...
class NtfsLongTermMemoryRecorder:
    ...
    def __init__(self, **kwargs):
        ...
        self._description = kwargs.get("description", "Records consolidated NTFS file system activities in long-term memory")
    ...
    def search_long_term_memory(
        ...
        """
        self._logger.info(f"Searching long-term memory for {query} (min importance: {importance_min}, limit: {limit})")
