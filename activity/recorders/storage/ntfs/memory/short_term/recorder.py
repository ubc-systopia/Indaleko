...
class NtfsShortTermMemoryRecorder:
    ...
    def __init__(self, **kwargs):
        ...
        self._description = kwargs.get("description", "Records preprocessed NTFS file system activities in short-term memory")
    ...
    def search_short_term_memory(self, query: str, importance_min: float = 0.0, limit: int = 10) -> List[Dict]:
        """
        ...
        """
        self._logger.info(f"Searching short-term memory for {query} (min importance: {importance_min}, limit: {limit})")
