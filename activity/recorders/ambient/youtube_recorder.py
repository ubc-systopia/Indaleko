...
class YouTubeActivityRecorder(RecorderBase):
    ...
    def process_data(self, activities: List[YouTubeVideoActivity]) -> List[Dict[str, Any]]:
        """
        ...
        for activity in activities:
            try:
                ...
                doc["_created"] = datetime.now(timezone.utc).isoformat()
    ...
    def store_data(self, data: Union[List[YouTubeVideoActivity], YouTubeVideoActivity]) -> bool:
        """
        Store activity data.
    ...
    def update_data(self, data: Union[List[YouTubeVideoActivity], YouTubeVideoActivity]) -> bool:
        """
