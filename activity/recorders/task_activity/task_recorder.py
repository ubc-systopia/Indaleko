...
class TaskActivityRecorder(RecorderBase):
    ...
    def create_semantic_attributes(self, task_data: TaskData) -> List[IndalekoSemanticAttributeDataModel]:
        """
    ...
    def store_task_activity(self, task_data: TaskData, action: str, previous_state: Optional[Dict] = None) -> Dict:
        """
    ...
    def get_latest_db_update(self, task_id: Optional[str] = None) -> Dict:
        """
