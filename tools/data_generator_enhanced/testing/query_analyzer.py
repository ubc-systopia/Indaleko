...
class QueryAnalyzer:
    ...
    def __init__(self, queries_file: str | Path | None = None) -> None:
    ...
    def load_queries(self, queries_file: str | Path) -> list[dict[str, Any]]:
        ...
        try:
            ...
            self.logger.exception(f"Query file not found: {queries_file}")
            raise

        except json.JSONDecodeError as e:
            self.logger.exception(f"Invalid JSON in query file: {e}")
    ...
    def generate_test_configurations(self, output_dir: str | Path) -> list[dict[str, Any]]:
