...
class SearchMetrics:
    ...
    def __init__(self, truth_ids: set[str], result_ids: set[str]) -> None:
...
class RankedSearchMetrics(SearchMetrics):
    ...
    def __init__(self, truth_ids: set[str], result_ids: list[str], relevance_scores: dict[str, float] | None = None) -> None:
