...
class MetadataDataset:
    ...
    def add_records(self, records: list[dict[str, Any]], truth_ids: set[str] | None = None) -> None:
    ...
    def save_to_file(self, directory: str | Path, suffix: str = "") -> str:
    ...
    @classmethod
    def load_from_file(cls, filepath: str | Path) -> "MetadataDataset":
...
class MetadataCollection:
    ...
    def create_dataset(self, dataset_type: str, name: str | None = None) -> MetadataDataset:
    ...
    def get_dataset(self, dataset_type: str) -> MetadataDataset | None:
    ...
    def save_to_directory(self, directory: str | Path) -> dict[str, str]:
