...
other storage data providers will use those same attributes.

Ideally, a storage provider will use a known semantic attribute if one
exists.  This simplifies reasoning across storage providers.
