...
class EntityInfo(IndalekoBaseModel):
    ...
    file_path: str | None = Field(default=None, description="File path if available")
...
class ResolutionRequest(IndalekoBaseModel):
    ...
    entity_type: EntityType = Field(default=EntityType.UNKNOWN, description="Type of entity (file, directory, etc.)")
