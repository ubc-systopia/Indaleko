...
from data_models import IndalekoRelationshipDataModel, \
...
class IndalekoRelationship:
    ...
    def __init__(
        ...
        if source_id is not None:
            assert isinstance(source_id, IndalekoSourceIdentifierDataModel), \
    ...
    def vertex_to_indaleko_uuid(
            self,
            vertex: Union[uuid.UUID, str, IndalekoUUIDDataModel]
    ) -> IndalekoUUIDDataModel:
    ...
    @staticmethod
    def vertex_to_uuid(vertex: Union[IndalekoUUIDDataModel, uuid.UUID, str]) -> IndalekoUUIDDataModel:
    ...
    @staticmethod
    def relationships_to_list(relationships: Union[List[Dict[str, str]], None]) -> List[Dict[str, str]]:
    ...
    def serialize(self) -> dict:
        ...
        assert self.relationships is not None and len(self.relationships) > 0, \
