...
def render_activity():
    ...
    st.markdown("<div class='sub-header'>View and understand your activity context</div>", unsafe_allow_html=True)
    ...
    st.info("This page visualizes your activity context data, showing how your files relate to your activities.")

    # Timeline selector
    timeline_options = ["Today", "Last 7 Days", "Last 30 Days", "Last 90 Days", "Custom Range"]
    ...
    activity_types = ["All Activities", "File Operations", "Communication", "Meetings", "Location", "Ambient Conditions"]
    selected_activity_types = st.multiselect("Activity Types", activity_types, default=["All Activities"])
    ...
    activities = [
        {"timestamp": "2025-04-07 14:32:00", "type": "file_created", "description": "Created presentation.pptx", "location": "Home Office"},
        {"timestamp": "2025-04-07 13:15:00", "type": "meeting", "description": "Team Standup", "location": "Home Office"},
        {"timestamp": "2025-04-07 11:45:00", "type": "email", "description": "Sent document to Bob", "location": "Coffee Shop"},
        {"timestamp": "2025-04-07 10:30:00", "type": "file_modified", "description": "Updated budget.xlsx", "location": "Coffee Shop"},
        {"timestamp": "2025-04-06 16:20:00", "type": "file_viewed", "description": "Viewed project_proposal.pdf", "location": "Office"},
    ]
