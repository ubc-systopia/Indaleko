...
def resolve_indaleko_objects(
    ...
    return multi_attribute_identity_resolution(file1_attrs, file2_attrs, threshold=threshold)


def _extract_identity_attributes(obj: Dict[str, Any]) -> Dict[str, Union[str, int, float]]:
    """
