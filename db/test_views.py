...
def execute_test_query(view_manager, query, analyzer=None):
    ...
    analyzers_to_test = [analyzer] if analyzer else ["text_en", "indaleko_filename", "indaleko_camel_case", "indaleko_snake_case"]
...
def main():
    ...
    parser.add_argument('--list-analyzers', action='store_true', help='List all analyzers')
    ...
    parser.add_argument('--analyzer', type=str, help='Specify analyzer to use with query (tests all analyzers if not specified)')
    parser.add_argument('--test-tokenization', action='store_true', help='Test tokenized search functionality')
    parser.add_argument('--test-camel-case', action='store_true', help='Test with CamelCase filenames')
    parser.add_argument('--test-snake-case', action='store_true', help='Test with snake_case filenames')
    parser.add_argument('--test-complex', action='store_true', help='Test with complex filenames (mixed separators)')
