...
def main2():
    ...
    parser.add_argument('--hostname', help='Hostname for the database', default='localhost')
    ...
    parser.add_argument('--timestamp', help='Timestamp for the configuration', default=datetime.now(timezone.utc))
    parser.add_argument('--admin_user', help='Admin user for the database', default='root')
    parser.add_argument(
        '--admin_password',
    ...
    parser.add_argument('--docker', help='Use Docker', default=False, action='store_true')
...
def main():
    ...
    list_parser = subparsers.add_parser('list', help='List the current configuration files.')
    list_parser.set_defaults(func=list_command)
    add_parser = subparsers.add_parser('add', help='Add a new configuration file.')
    add_parser.add_argument('--hostname', help='Hostname for the database', default='localhost')
    ...
    add_parser.add_argument('--timestamp', help='Timestamp for the configuration', default=datetime.now(timezone.utc))
    add_parser.add_argument('--admin_user', help='Admin user for the database', default='root')
    ...
    add_parser.add_argument('--docker', help='Use Docker', default=False, action='store_true')
