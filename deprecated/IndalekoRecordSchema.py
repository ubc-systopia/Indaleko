...
class IndalekoRecordSchema(IndalekoDataSchema):
    ...
    def __init__(self, **kwargs):
        ...
        record_rules = apischema.json_schema.deserialization_schema(
            IndalekoRecordDataModel.IndalekoRecord, additional_properties=True
        )
        ...
        schema_description = kwargs.get(
            "schema_description",
            "Schema for the JSON representation of an abstract record in Indaleko.",
        )
        super().__init__(
            schema_id=schema_id,
    ...
    def old_get_schema(self: "IndalekoRecordSchema") -> dict:
        ...
        schema["rule"]["properties"]["Record"] = record_schema.get_json_schema()[
            "rule"
        ]["properties"]
