...
class IndalekoRelationshipSchema(IndalekoRecordSchema):
    ...
    def __init__(self, **kwargs):
        ...
        schema_id = kwargs.get(
            "schema_id",
            "https://activitycontext.work/schema/indaleko-relationship.json",
        )
        schema_title = kwargs.get("schema_title", "Indaleko Relationship Schema")
        schema_description = kwargs.get(
            "schema_description",
            "Schema for the JSON representation of an Indaleko Relationship.",
        )
        super().__init__(
            schema_id=schema_id,
    ...
    def is_valid_relationship(indaleko_relationship: dict) -> bool:
        ...
        try:
            validate(
                instance=indaleko_relationship,
...
def main():
    ...
    if IndalekoRelationshipSchema.is_valid_json_schema_dict(
        IndalekoRelationshipSchema().get_json_schema()
    ):
