...
class IndalekoRecordDataModel:
    ...
    class IndalekoRecord:
        ...
        def deserialize(
            ...
            return deserialize(
                IndalekoRecordDataModel.IndalekoRecord, data, additional_properties=True
            )
    ...
    def get_indaleko_record() -> "IndalekoRecordDataModel.IndalekoRecord":
        ...
        return IndalekoRecordDataModel.IndalekoRecord(
            SourceIdentifier=IndalekoDataModel.get_source_identifier(
...
def main():
    ...
    ic(
        print_schema(
            graphql_schema(
                query=IndalekoRecordDataModel.get_queries(),
