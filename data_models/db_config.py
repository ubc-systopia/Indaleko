...
def main():
    ...
    db_config_data = IndalekoDBConfigDataModel(**IndalekoDBConfigDataModel.Config.json_schema_extra['example'])
    ic(db_config_data.model_dump_json(indent=2, exclude_unset=True, exclude_none=True))
    print(db_config_data.model_dump_json(indent=2, exclude_unset=True, exclude_none=True))
