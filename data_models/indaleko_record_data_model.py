...
class IndalekoRecordDataModel(BaseModel):
    '''
    ...
    @staticmethod
    def deserialize(data : Union[Dict[str, Any], str]) -> 'IndalekoUUID':
        '''Deserialize the data model'''
        if isinstance(data, str):
            return IndalekoRecordDataModel.parse_raw(data)
        elif isinstance(data, dict):
            return IndalekoRecordDataModel(**data)
        else:
...
def main():
    ...
    ic(IndalekoRecordDataModel.schema_json())
