...
import uuid
import logging
from typing import Dict, List, Optional, Any, Set, Type, cast
...
class EntityRegistry:
    ...
    def register_entity(self, entity: Entity) -> None:
        ...
        if entity.entity_id in self.entities:
            self.logger.warning(f"Entity with ID {entity.entity_id} already registered, replacing")
        
        self.entities[entity.entity_id] = entity
        self.logger.info(f"Registered entity: {entity.name} (ID: {entity.entity_id})")
    
    def register_entity_type(self, entity_type: Type[Entity], type_name: Optional[str] = None) -> None:
        """
        ...
        if type_name in self.entity_types:
            self.logger.warning(f"Entity type {type_name} already registered, replacing")
    ...
    def get_entities_by_capability(self, capability: EntityCapability) -> List[Entity]:
        ...
        return [
            ...
            if entity.can(capability)
        ]
    
    def get_entities_by_name(self, name: str, partial_match: bool = False) -> List[Entity]:
        """
