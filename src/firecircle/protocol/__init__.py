...
STORYTELLER_PROFILE = EntityProfile(
    ...
    capabilities=["narrative_pattern_recognition", "metaphorical_thinking", "emotional_intelligence"],
...
CRITIC_PROFILE = EntityProfile(
    ...
    capabilities=["critical_thinking", "alternative_perspective_generation", "bias_identification"],
