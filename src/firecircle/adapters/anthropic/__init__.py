...
class AnthropicAdapter(ModelAdapter):
    ...
    def _convert_to_anthropic_messages(self, messages: List[FireCircleMessage]) -> List[Dict[str, Any]]:
        ...
        return [
            {
                "role": role_mapping.get(msg.role, "user"),  # Default to user for unknown roles
                "content": msg.content
            }
            for msg in messages
        ]
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            "provider": "anthropic",
            "model": self.model,
            "features": capabilities.get(model_family, {
                "token_window": 100000,
                "vision": True,
                "tools": False
            })
