...
def extract_collections() -> list[dict[str, Any]]:
    ...
    try:
        ...
        for collection in user_collections:
            ...
            # Get description
            description = COLLECTION_DESCRIPTIONS.get(collection_name, f"{collection_type.capitalize()} collection")
...
def extract_relationships(collections: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    semantic_relationships = [
        {"from": "SemanticData", "to": "Objects", "type": "enriches", "description": "Semantic data enriches objects"},
        {
        ...
        {"from": "Users", "to": "FeedbackRecords", "type": "provides", "description": "Users provide feedback records"},
        {
            "from": "LearningEvents",
